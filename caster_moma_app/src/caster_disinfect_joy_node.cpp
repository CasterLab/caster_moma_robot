...
bool InitialPose(caster_moma_app::PickGift::Request &req, caster_moma_app::PickGift::Response &res) {
  if(!init_pose) {
...
bool Stop(caster_moma_app::PickGift::Request &req, caster_moma_app::PickGift::Response &res) {
  stop = true;
  return true;
}

bool Disinfect(caster_moma_app::PickGift::Request &req, caster_moma_app::PickGift::Response &res) {
